 ...
 * @param {*} el 挂载节点
 */
function init(el = "starCanvasOverlay") {
  var mobile = false;
  ...
  let target = document.getElementById("starCanvasOverlay");
  if (target.hasChildNodes()) {
    target.removeChild(target.childNodes[0]);
  }

  var canvasWidth = target.clientWidth;
  var canvasHeight = target.clientHeight;
